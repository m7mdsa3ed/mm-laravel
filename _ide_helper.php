    ...
    class Http
    {
        ...
        public static function macroCall($method, $parameters)
        {
            ...
            return $instance->macroCall($method, $parameters);
                     ...
                     *
                     *
                     * @see \App\Providers\MacroServiceProvider::httpClientHandlerMacro()
                     * @param \App\Http\Requests\HttpRequest $httpRequest
                     * @static
                     */
        public static function execute($httpRequest)
        {
            return \Illuminate\Http\Client\Factory::execute($httpRequest);
        }
    }
    /**
     *
...
namespace Illuminate\Database\Query {
    ...
    class Builder
    {
         ...
         *
         *
         * @see \App\Providers\MacroServiceProvider::toRawSqlMacro()
         * @static
         */
